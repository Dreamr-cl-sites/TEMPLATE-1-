      ...
      <div className="container py-16 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <div className="font-display font-extrabold text-xl">{site.name}</div>
          </Link>
          <p className="mt-4 text-sm text-white/70 leading-relaxed">{site.description}</p>
        ...
        <div>
          <div className="text-xs uppercase tracking-[0.2em] text-brand-accent font-semibold">Services</div>
        ...
        <div>
          <div className="text-xs uppercase tracking-[0.2em] text-brand-accent font-semibold">Contact</div>
